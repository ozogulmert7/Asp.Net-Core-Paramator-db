...
public partial class ParamotordbContext : DbContext
{
    ...
    public ParamotordbContext(DbContextOptions<ParamotordbContext> options) : base(options) { }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) =>
        optionsBuilder.UseMySql(
            "server=localhost;port=3306;database=paramotordb;user=root",
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Message>(entity =>
        {
            ...
            entity.Property(e => e.Isview).HasColumnName("isview");
            entity.Property(e => e.Order).HasColumnName("order");
            entity.Property(e => e.Subtitle).HasMaxLength(150).HasColumnName("subtitle");
            entity.Property(e => e.Title).HasMaxLength(100).HasColumnName("title");
            entity.Property(e => e.Url).HasMaxLength(150).HasColumnName("url");
            entity.Property(e => e.UrlTarget).HasMaxLength(50).HasColumnName("urlTarget");
            entity.Property(e => e.UrlText).HasMaxLength(150).HasColumnName("urlText");
        });
        ...
        modelBuilder.Entity<Service>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Image).HasMaxLength(150).HasColumnName("image");
            entity.Property(e => e.Isview).HasColumnName("isview");
            entity.Property(e => e.Order).HasColumnName("order");
            entity
                .Property(e => e.Subtitle)
            ...
            entity.Property(e => e.UrlTarget).HasMaxLength(50).HasColumnName("urlTarget");
            entity.Property(e => e.UrlText).HasMaxLength(200).HasColumnName("urlText");
        });
        ...
        modelBuilder.Entity<Slide>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Image).HasMaxLength(250).HasColumnName("image");
            entity.Property(e => e.Isview).HasDefaultValueSql("'0'").HasColumnName("isview");
            entity.Property(e => e.Order).HasColumnName("order");
            ...
            entity.Property(e => e.Url).HasMaxLength(250).HasColumnName("url");
            entity.Property(e => e.UrlTarget).HasMaxLength(50).HasColumnName("urlTarget");
            entity.Property(e => e.UrlText).HasMaxLength(250).HasColumnName("urlText");
        });
        ...
        modelBuilder.Entity<Team>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Facebook).HasMaxLength(200).HasColumnName("facebook");
            entity
                .Property(e => e.Image)
                .HasMaxLength(250)
                .HasDefaultValueSql("'0'")
                .HasColumnName("image");
            entity.Property(e => e.Instagram).HasMaxLength(200).HasColumnName("instagram");
            entity.Property(e => e.Isview).HasColumnName("isview");
            entity.Property(e => e.Linkedin).HasMaxLength(200).HasColumnName("linkedin");
            entity.Property(e => e.Order).HasColumnName("order");
            entity
                .Property(e => e.Subtitle)
                .HasMaxLength(250)
            ...
            entity
                ...
                .HasDefaultValueSql("'0'")
                .HasColumnName("title");
            entity.Property(e => e.Twitter).HasMaxLength(200).HasColumnName("twitter");
            entity.Property(e => e.Youtube).HasMaxLength(200).HasColumnName("youtube");
        });
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.Password).HasMaxLength(150).HasColumnName("password");
        });
